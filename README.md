...
| -------------  | --- |
| :sparkles: Nome        | **🪙 iManager Interface**
| :label: Tecnologias | reactjs, css module, react router, react animate on scroll, react animated number, react icons, react responsive carousel, custom react cursor, uuid, animete.css, gsap, vitejs, javascript, css, html, yarn
